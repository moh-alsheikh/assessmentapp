...
student_role = Role.where(name: "Students").first_or_create
User.create_with(name: "teacher", password: "12345678", role_id: teacher_role.id).first_or_create(email: "teacher@example.com")
